...
let command = {
    ...
    run: (message, client, args) => {
        ...
        let usuario = ((_b = (_a = message.mentions) === null || _a === void 0 ? void 0 : _a.members) === null || _b === void 0 ? void 0 : _b.first()) || ((_c = message.guild) === null || _c === void 0 ? void 0 : _c.members.resolve(args[0]));
        let role = (_d = message.guild) === null || _d === void 0 ? void 0 : _d.roles.cache.find(x => x.name === 'Silenciado');
