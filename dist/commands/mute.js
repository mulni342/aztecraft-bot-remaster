...
let command = {
    ...
    run: (message, client, args) => {
        ...
        let usuario = ((_a = message.mentions.members) === null || _a === void 0 ? void 0 : _a.first()) || ((_b = message.guild) === null || _b === void 0 ? void 0 : _b.members.resolve(args[0]));
        let razon = args[1] ? args.slice(1).join(' ') : 'No definido.';
        let role = (_c = message.guild) === null || _c === void 0 ? void 0 : _c.roles.cache.find(x => x.name === 'Silenciado');
