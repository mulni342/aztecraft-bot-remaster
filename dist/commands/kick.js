...
let command = {
    ...
    run: (message, client, args) => {
        ...
        var perms = (_a = message.member) === null || _a === void 0 ? void 0 : _a.permissions.has("KICK_MEMBERS");
        if (!perms)
        ...
        try {
            ...
            let member = (_b = message.guild) === null || _b === void 0 ? void 0 : _b.members.cache.find(m => m.id == (user === null || user === void 0 ? void 0 : user.id));
